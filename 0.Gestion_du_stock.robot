...
CTNM - Authentification
	Input Text    xpath=//*[@id="username"]    admin1
...
CTNM - Gestion de Stock
	...
	Location Should Be		http://192.168.200.61:8000/dolibarr/product/index.php?mainmenu=products&leftmenu=
	
CTNM - Creation d'un nouveau produit
	Click Element		xpath=//*[@id="id-left"]/div/div[3]/div[3]/a
	Location Should Be		http://192.168.200.61:8000/dolibarr/product/card.php?leftmenu=product&action=create&type=0
	...
	Location Should Contain 		http://192.168.200.61:8000/dolibarr/product/card.php?id=
...
CTEX - Creation d'un produit deja existant
	...
	Input Text	  xpath=//*[@id="id-right"]/div/form/div[2]/table[1]/tbody/tr[2]/td[2]/input		Libelle1
	Click Button	  xpath=//*[@id="id-right"]/div/form/div[3]/input[1]
	Location Should Be 		http://192.168.200.61:8000/dolibarr/product/card.php
